module Pancake
  ...
  module Middleware
    ...
    # The inner StackMiddleware class is also set to be inherited with the base class (and all children classes)
    # So that each class gets its own copy and may maintain the base stack from the parent, but edit it in the child.
